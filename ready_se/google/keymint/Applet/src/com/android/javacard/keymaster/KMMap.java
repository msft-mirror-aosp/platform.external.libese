...
public class KMMap extends KMType {
  ...
  public void add(short index, short keyPtr, short valPtr) {
    ...
    short keyIndex = (short) (getStartOff() + (short) (index * 4));
  ...
  public short getKey(short index) {
    assertWithinBounds(index, (short) (length() - 1));
    return Util.getShort(heap, (short) (getStartOff() + (short) (index * 4)));
  }

  public short getKeyValue(short index) {
    assertWithinBounds(index, (short) (length() - 1));
    return Util.getShort(heap, (short) (getStartOff() + (short) (index * 4 + 2)));
  }
  ...
  public void swap(short index1, short index2) {
    ...
    // Swap keys
    short indexPtr1 = Util.getShort(heap, (short) (offset + (index1 * 4)));
    short indexPtr2 = Util.getShort(heap, (short) (offset + (index2 * 4)));
    Util.setShort(heap, (short) (offset + index1 * 4), indexPtr2);
    Util.setShort(heap, (short) (offset + index2 * 4), indexPtr1);

    // Swap Values
    indexPtr1 = Util.getShort(heap, (short) (offset + (short) (index1 * 4 + 2)));
    indexPtr2 = Util.getShort(heap, (short) (offset + (short) (index2 * 4 + 2)));
    Util.setShort(heap, (short) (offset + (short) (index1 * 4 + 2)), indexPtr2);
    Util.setShort(heap, (short) (offset + (short) (index2 * 4 + 2)), indexPtr1);
  }
